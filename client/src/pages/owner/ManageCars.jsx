...
const ManageCars = () => {
    ...
    const deleteCar = async (carId)=>{
        try {
            ...
            const confirm = window.confirm('Please confirm if you want to delete this car?')
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
        ...
        <Title title="Manage Cars"
           subTitle="Access and manage your car listings — update information, 
            view all entries, or remove them from the platform.."/>
